...
function handleHTML_mainReport($smarty, $module_name, $local_templates_dir)
{
    ...
    if (!isFestivalActive()) {
        $smarty->assign('mb_title', _tr('Mensagem'));
        $smarty->assign('mb_message', _tr('Festival não esta ativo'));
    }
    ...
    $smarty->assign(array(
        ...
        'title'                     =>  _tr('Calendário'),
        'icon'                      =>  'modules/'.$module_name.'/images/agenda_calendar.png',
        'LBL_CREATE_EVENT'          =>  _tr('Criar Novo Evento'),
        'Color'                     =>  _tr('Cor'),
        'add_phone'                 =>  _tr('Pesquisar nos contatos'),
        'Listen'                    =>  _tr('Ouvir'),
        'Listen_here'               =>  _tr('Clique aqui para ouvir'),
        'Notification_Alert'        =>  _tr('Alertas de Notificação'),
...
function handleJSON_phone_numbers($smarty, $module_name, $local_templates_dir)
{
    ...
    $smarty->assign(array(
        ...
        'SHOW'                  =>  _tr('Mostrar'),
        'CSV'                   =>  _tr('CSV'),
        'Phone_Directory'       =>  _tr('Contatos'),
        'Internal'              =>  _tr('Internos'),
        'External'              =>  _tr('Externos'),
    ));
    ...
    $oGrid->addFilterControl(
        _tr("Filter applied ")._tr("Contatos")." =  $directory_type ",
        $arrFilter,
