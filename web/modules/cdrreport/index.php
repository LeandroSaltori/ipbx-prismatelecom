...
function _moduleContent(&$smarty, $module_name)
{
    ...
    $arrFormElements = array(
        ...
        "field_name"  => array("LABEL"                  => _tr("Field Name"),
                            ...
                            "INPUT_EXTRA_PARAM"      => array( "dst"         => _tr("Destination"),
                                                               ...
                                                               "userfield"   => _tr("Campo do Usuário")),
                            "VALIDATION_TYPE"        => "ereg",
    ...
    $oGrid->addFilterControl(_tr("Filtro Aplicado: ")._tr("Start Date")." = ".$paramFiltro['date_start'].", "._tr("End Date")." = ".
    ...
    if($oGrid->isExportAction()){
      ...
      $oGrid->setColumns($arrColumns);
        ...
        $arrColumns = array(_tr("Date"), _tr("Source"), _tr("Ring Group"), _tr("Destination"), _tr("Src. Channel"),_tr("Account Code"),_tr("Dst. Channel"),_tr("Status"),_tr("Duration"),_tr("ID único"),_tr("Campo do usúario"));
