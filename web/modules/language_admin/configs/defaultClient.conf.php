<?php
  ...
  |                                                                      |
  | Translate by: Jonathan Vega                                          |
  | Email: jvega@palosanto.com                                           |
  +----------------------------------------------------------------------+
  $Id: default.conf.php,v 1.1 2008-07-08 11:07:07 jvega Exp $ */
        global $arrConfig;
        $arrConfig['module_name'] = 'language_admin';
        $arrConfig['templates_dir'] = 'themes';
        $arrConfig['url_webservices']   = 'https://192.168.1.179/modules/language_admin/webservice/supportWSDL2.wsdl';
?>
