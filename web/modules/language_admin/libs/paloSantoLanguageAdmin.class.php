...
class paloSantoLanguageAdmin {
    ...
    function saveTraslate($module_name, $lang_name, $lang_english, $lang_traslate)
    {
        ...
        $output = $retval = NULL;
        exec('/usr/bin/issabel-helper develbuilder --addtranslation'.
    ...
    {    	
        ...
        $output = $retval = NULL;
        exec('/usr/bin/issabel-helper develbuilder --createlanguage '.
    ...
    function saveAll($arrayLangTrasl, $module, $language)
    {
        ...
        $output = $retval = NULL;
        exec('/usr/bin/issabel-helper develbuilder --savetranslation '.escapeshellarg($sTempFile).' 2>&1',
            $output, $retval);
        unlink($sTempFile);
        if ($retval != 0) {
            $this->errMsg = array(
