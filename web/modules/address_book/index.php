    ...
    $arrGrid = array(   "title"    => _tr("Address Book"),
                        ...
                        "columns"  => array(0 => array("name"      => $name,
                                            ...
                                            2 => array("name"      => _tr("Name"),
                                                    "property1" => ""),
                                            3 => array("name"      => ($directory_type=='external')?_tr("Telefone"):_tr("Extension"),
                                                    "property1" => ""),
...
function createFieldForm($directory)
{
    $arrFields = array(
               ...
               "name"          => array(   "LABEL"                 => ($directory=='external')?_tr("First Name"):_tr("Name"),
                ...
                "work_phone"    => array(   "LABEL"                 => ($directory=='external')?_tr("Telefone"):_tr("Extension"),
                                            "REQUIRED"              => ($directory=='external')?"yes":"no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => ($directory=='external')?"":array("disabled" => "disabled","readonly" => "readonly"),
                                            "VALIDATION_TYPE"       => "ereg",
                                            "VALIDATION_EXTRA_PARAM"=> "^[\*|#]*[[:digit:]]*$"),
                "department"    => array(   "LABEL"                 => _tr("Departamento"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "cell_phone"    => array(   "LABEL"                 => _tr("Celular"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => "",
                                            "VALIDATION_TYPE"       => "ereg",
                                            "VALIDATION_EXTRA_PARAM"=> "^[\*|#]*[[:digit:]]*$"),
                "home_phone"    => array(   "LABEL"                 => _tr("WhattsApp"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => "",
                                            "VALIDATION_TYPE"       => "ereg",
                                            "VALIDATION_EXTRA_PARAM"=> "^[\*|#]*[[:digit:]]*$"),
// /* Campos Apagados- Prisma Telecom	   
				"fax1"          => array(   "LABEL"                 => _tr("Telefone Comercial 1"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => "",
                                            "VALIDATION_TYPE"       => "ereg",
                                            "VALIDATION_EXTRA_PARAM"=> "^[\*|#]*[[:digit:]]*$"),
                "fax2"          => array(   "LABEL"                 => _tr("Telefone Comercial 2"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => "",
                                            "VALIDATION_TYPE"       => "ereg",
                                            "VALIDATION_EXTRA_PARAM"=> "^[\*|#]*[[:digit:]]*$"),
//Fim campos apagados - Prisma Telecom   */ 
                ...
                "picture"   => array(      "LABEL"                  => _tr("picture"),
                                            ...
                                            "VALIDATION_TYPE"        => "text",
                                            "VALIDATION_EXTRA_PARAM" => ""),
                "province"    => array(     "LABEL"                 => _tr("Pais"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "city"        => array(     "LABEL"                 => _tr("Cidade"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "address"     => array(     "LABEL"                 => _tr("Endereço"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "company"     => array(     "LABEL"                 => _tr("Empresa"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "company_contact" => array( "LABEL"                 => ($directory=='external')?_tr("Responsavel"):_tr("Cargo"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                                            "VALIDATION_EXTRA_PARAM"=> ""),
                "contact_rol" => array(     "LABEL"                 => ($directory=='external')?_tr("Setor"):_tr("Setor"),
                                            "REQUIRED"              => "no",
                                            "INPUT_TYPE"            => "TEXT",
                                            "INPUT_EXTRA_PARAM"     => array("style" => "width:300px;"),
                                            "VALIDATION_TYPE"       => "text",
                ...
                "notes"   => array(         "LABEL"                  => _tr("Notes"),
                                            "REQUIRED"               => "no",
                                            "INPUT_TYPE"             => "TEXTAREA",
                                            "INPUT_EXTRA_PARAM"      => array("id" => "Observações"),
                                            "VALIDATION_TYPE"        => "text",
                                            "EDITABLE"               => "si",
                                            "COLS"                   => "40",
                                            "ROWS"                   => "4",
