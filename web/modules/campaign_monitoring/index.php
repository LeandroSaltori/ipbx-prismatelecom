...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  $Id: br.lang,v 1.0 2020/05/23 - Prisma Telecom Franca SP - leandro@prismatelecom.com $ */
...
function manejarMonitoreo_HTML($module_name, $smarty, $sDirLocalPlantillas)
{
    ...
    $smarty->assign(array(
        ...
        'ETIQUETA_CAMPANIA'             =>  _tr('Campanha'),
        'ETIQUETA_FECHA_INICIO'         =>  _tr('Data Inicial'),
        'ETIQUETA_FECHA_FINAL'          =>  _tr('Data Final'),
        'ETIQUETA_HORARIO'              =>  _tr('Horário'),
        'ETIQUETA_COLA'                 =>  _tr('Nº da Fila'),
        'ETIQUETA_INTENTOS'             =>  _tr('Tentar Rediscagem'),
        'ETIQUETA_TOTAL_LLAMADAS'       =>  _tr('Total Ligações'),
		'ETIQUETA_LLAMADAS_PENDIENTES'  =>  _tr('Ligações Pendentes'),
        'ETIQUETA_LLAMADAS_FALLIDAS'    =>  _tr('Falha Ligações'),
        'ETIQUETA_LLAMADAS_CORTAS'      =>  _tr('Ligações Improdutivas'),
        'ETIQUETA_LLAMADAS_EXITO'       =>  _tr('Ligações Atendidas'),
        'ETIQUETA_LLAMADAS_MARCANDO'    =>  _tr('Ligações Em Andamento'),
        'ETIQUETA_LLAMADAS_COLA'        =>  _tr('Ligações Na Fila'),
        'ETIQUETA_LLAMADAS_TIMBRANDO'   =>  _tr('Ligações Tocando'),
        'ETIQUETA_LLAMADAS_ABANDONADAS' =>  _tr('Ligações Abandonadas'),
        'ETIQUETA_LLAMADAS_NOCONTESTA'  =>  _tr('Não Atendidas'),
        'ETIQUETA_LLAMADAS_TERMINADAS'  =>  _tr('Ligações Finalizadas'),
        'ETIQUETA_LLAMADAS_SINRASTRO'   =>  _tr('Lost track'),
        'ETIQUETA_AGENTES'              =>  _tr('Agents'),
        'ETIQUETA_NUMERO_TELEFONO'      =>  _tr('Numero'),
        'ETIQUETA_TRONCAL'              =>  _tr('Tronco'),
        'ETIQUETA_ESTADO'               =>  _tr('Status'),
        'ETIQUETA_DESDE'                =>  _tr('Duração'),
        'ETIQUETA_AGENTE'               =>  _tr('Agente'),
        'ETIQUETA_REGISTRO'             =>  _tr('Vizualizar Log de Campanha'),
        'PREVIOUS_N'                    =>  _tr('Vizualizar 100 entradas anteriores'),
        'ETIQUETA_MAX_DURAC_LLAM'       =>  _tr('Duração Máxima da Chamada'),
        'ETIQUETA_PROMEDIO_DURAC_LLAM'  =>  _tr('Duração média da chamada'),
    ));
