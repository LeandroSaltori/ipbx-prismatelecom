                    ...
                    click: function() {
                        ...
                        if (d != null) {
                            ...
                            .fail(function(result) {
                                ...
                                alert('Falha ao criar novo evento: ' + result.error.fm + ' - ' + result.error.fd);
                            });
                        }
                    }
                },
        ...
        */
        eventDrop: function(event, dayDelta, minuteDelta, allDay, revertFunc,
            ...
            $.post(event.url, {
                ...
                // TODO: i18n
                result = $.parseJSON(result.responseText);
                alert('Falha ao atualizar o início do evento: ' + result.error.fm + ' - ' + result.error.fd);
            });
        },
        eventResize: function( event, dayDelta, minuteDelta, revertFunc,
            ...
            $.post(event.url, {
                ...
                revertFunc();
                result = $.parseJSON(result.responseText);
                alert('Falha ao atualizar a duração do evento: ' + result.error.fm + ' - ' + result.error.fd);
            });
        },
...
function openEventDialog(url)
{
    ...
    $.get(url, function(result) {
                    ...
                    click: function() {
                        ...
                        if (d != null) {
                            ...
                            .fail(function(result) {
                                // TODO: i18n
                                result = $.parseJSON(result.responseText);
                                alert('Falha ao atualizar o evento: ' + result.error.fm + ' - ' + result.error.fd);
                            });
                        }
                    }
                },
                    ...
                    click: function() {
                        ...
                        if (confirm('Tem certeza que deseja remover este evento?')){
                            ...
                            .fail(function(result) {
                                // TODO: i18n
                                result = $.parseJSON(result.responseText);
                                alert('Falha ao remover o evento: ' + result.error.fm + ' - ' + result.error.fd);
                            });
                        }
                    }
                },
        ...
        // TODO: i18n
        result = $.parseJSON(result.responseText);
        alert('Falha ao buscar o evento: ' + result.error);
    });
}
