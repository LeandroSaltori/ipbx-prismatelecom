<?php
  ...
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2013-08-12 08:08:53 Jose Briones jbriones@elastix.com Exp $ */
...
function _moduleContent(&$smarty, $module_name)
{
    ...
    include_once "modules/$module_name/libs/paloSantoFax_Utilities.class.php";
    ...
    switch($action){
        default: // view_form
            $content = viewFormFax_Utilities($smarty, $module_name, $local_templates_dir, $arrConf);
            break;
    }
    return $content;
}
