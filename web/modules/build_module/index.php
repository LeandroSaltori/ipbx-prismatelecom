...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: index.php, Mon 04 May 2020 10:24:22 PM EDT, nicolas@issabel.com
*/
...
function save_module($smarty, $module_name, $local_templates_dir, $arrLangModule, &$pDB_acl, $arrConf)
{
    ...
    $pNewMod = new paloSantoBuildModule(
        $arrConf['issabel_dsn']['settings'],
        $arrConf['issabel_dsn']['menu'],
        $arrConf['issabel_dsn']['acl']);
    ...
    if($error) {
        ...
        $message = _tr('The module was created successfully').'. '.
