<?php
  ...
  +----------------------------------------------------------------------+
  $Id: paloSantoGeoIP_KEY.class.php,v 1.1 2020-02-28 11:02:09 German Venturino german@issabel.com Exp $ */
class paloSantoGeoIP_KEY{
    var $_DB;
    var $errMsg;

    function paloSantoGeoIP_KEY(&$pDB)
    {
