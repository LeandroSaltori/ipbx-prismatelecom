<?php
  ...
  +----------------------------------------------------------------------+
  | The Initial Developer of the Original Code is Issabel                |
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2020-02-28 11:02:09 German Venturino german@issabel.com Exp $ */
...
function _moduleContent(&$smarty, $module_name)
{
    ...
    include_once "modules/$module_name/libs/paloSantoGeoIP_KEY.class.php";
...
{
    $pGeoIP_KEY = new paloSantoGeoIP_KEY($pDB);
