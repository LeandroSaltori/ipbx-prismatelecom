...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/logo_prisma.png" width="200" alt="" />
            </a>
        </div>
        <!-- logo collapse icon -->
    ...
    <span style='float:right; width:400px;'>
        ...
        <li id="header_notification_bar" class="profile-info dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <!-- Profile sub-links -->
                <li><a href="http://www.prismatelecom.com" class="register_link">{$Registered}</a></li>
                <!-- <li><a href="#" id="viewDetailsRPMs"><i class="fa fa-cube"></i>{$VersionDetails}</a></li> --!>
                <li><a href="http://www.prismatelecom.com" target="_blank"><i class="fa fa-external-link"></i>Prisma Telecom Website</a></li>
