...
<html>
    <head>
        ...
        <title>IPbx - Prisma Telecom</title>
    ...
    <div class="page-container">
        ...
        <footer class="main" style="margin-left:16px;">
            <a href="http://www.prismatelecom.com" style="color: #444; text-decoration: none;" target='_blank'>IPbx | Prisma Telecom 2006 - {$currentyear}.</a>
        </footer>
